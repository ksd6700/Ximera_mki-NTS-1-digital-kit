...
Ximera MKI is a custom oscillator for KORG logue SDK v1 instruments, imagined as a meeting point between the bright virtual-analog character of the Nord Lead, the expansive supersaw sound associated with the JP-8080, and the weight and drive of a Minimoog-style voice. It is not an exact emulation of any one instrument; it combines those influences into a compact, playable oscillator with its own character.

Inside a single oscillator slot, Ximera MKI layers seven band-limited saw voices with square/parabolic edge, a one-octave-down sub oscillator, an internal two-pole tone filter, and soft drive. It is designed for bold mono leads, wide chord stabs, and rounded bass sounds on the Nu:Tekt NTS-1 digital kit mkI, minilogue xd, and prologue.
